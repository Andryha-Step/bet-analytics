...
export const LockedBuy = observer(({}: Props) => {
	return (
		<View style={styles.container}>
			<Image style={styles.bgImage} source={require('../icons/default-forecast.png')} />
			<View style={styles.body}>
				<Text style={styles.title}>Прогноз недоступен</Text>
				<Text style={styles.descripton}>
					События в этом прогнозе стартовали.{'\n'}После завершения событий прогноз появится в списке завершенных. Пока можете посмотреть
					другие прогнозы.
				</Text>
			</View>
		</View>
